...
const ValidateAcount = (props) => {
    ...
    return (
        <>
            ...
            <p>Su cuenta fue creada exitosamente, pero para poder utilizar la cuenta hay que validar la cuenta con el correo electrónico. En el formulario de abajo ingrese el código de verificación enviado al correo electrónico con el que creó la cuenta.</p>
            <Form
                name="basic"
